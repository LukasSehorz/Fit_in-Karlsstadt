  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[560px] items-center overflow-hidden md:min-h-[660px]">
        <Image
          src="/images/kontakt-hero-v2.jpg"
          alt="Empfang und Wartebereich der Physiotherapie im Fit-in Gesundheitszentrum"
          fill
          priority
          sizes="100vw"
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-24 pt-36 md:px-8">
          ...
          >
            Sprechen Sie mit unserem Therapie-Team
          </motion.h1>
          ...
          >
            Unverbindlich, persönlich und nah – wir nehmen uns Zeit für Ihr
            Anliegen und finden gemeinsam den passenden Weg für Ihre Behandlung.
          </motion.p>
      ...
      >
        <FadeUp>
          ...
          >
            <h2 className="font-display text-display-md text-ink">Termin anfragen</h2>
        ...
        <aside className="space-y-6">
          <FadeUp delay={0.1}>
            <div className="rounded-3xl bg-forest p-8 text-cream shadow-xl shadow-forest/10">
              <h3 className="font-display text-2xl">So erreichen Sie uns</h3>
          ...
          <FadeUp delay={0.2}>
            <div className="rounded-3xl border hairline bg-paper p-8">
              <h3 className="flex items-center gap-2 font-display text-xl text-ink">
                <Clock className="size-5 text-leaf" /> Öffnungszeiten
              </h3>
              <ul className="mt-4 space-y-2 text-sm">
                {oeffnungszeiten.map((o) => (
                  ...
                  >
                    ...
                    <span className="text-mist">{o.zeit}</span>
                  </li>
                ))}
              </ul>
              <p className="mt-4 text-xs leading-relaxed text-mist">
                Öffnungszeiten des Fit-in Gesundheitszentrums. Termine in der
                Physiotherapie nach Vereinbarung.
              </p>
            </div>
          </FadeUp>
          ...
          <FadeUp delay={0.3}>
            <div className="aspect-[4/3] overflow-hidden rounded-3xl border hairline">
              <iframe
                title="Karte – Fit-in Gesundheitszentrum, Am Steinlein 6, Karlstadt"
                className="size-full"
                loading="lazy"
                src={mapSrc}
              />
