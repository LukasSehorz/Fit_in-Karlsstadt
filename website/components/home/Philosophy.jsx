          ...
          <div className="order-2 lg:order-1">
            <Parallax amount={36} className="arch relative mx-auto aspect-[3/4] max-w-md overflow-hidden lg:mx-0">
              <ImageReveal className="h-full w-full">
                <Image
                  src="/images/manuelle-therapie.png"
          ...
          <div className="order-1 flex flex-col justify-center lg:order-2">
            ...
            <FadeUp delay={0.15}>
              <p className="mt-8 max-w-xl leading-relaxed text-mist">
                Uns ist wichtig, dass Sie während Ihrer Behandlungsserie in der
                Hand eines einzelnen Therapeuten sind, der sich genau mit Ihnen
                und Ihrem Körper befassen kann. So gehen wir auf Ihre speziellen
                Probleme und Wünsche ein, statt nach einem festen Schema zu
                behandeln.
              </p>
            </FadeUp>
            <FadeUp delay={0.25}>
              <p className="mt-5 max-w-xl leading-relaxed text-mist">
                ...
                erfolgt auf Wunsch eine enge Absprache mit unseren
                Verantwortlichen für den Fitnessbereich. So gelingt ein
                optimaler Übergang zu einem anschließenden, auf Sie
                zugeschnittenen Training.
              </p>
            </FadeUp>
            <FadeUp delay={0.35} className="mt-10">
              <Link href="/ueber-uns" className="btn btn-outline group w-fit">
