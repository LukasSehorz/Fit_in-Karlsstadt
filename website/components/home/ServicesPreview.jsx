      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <SplitWords
              as="h2"
              text="Vier Bereiche, ein *Ziel.*"
              className="font-display text-display-lg text-ink"
            />
            <FadeUp delay={0.15}>
              <p className="mt-6 max-w-xl leading-relaxed text-mist">
                Von der Physiotherapie über das Reha-Training und den Rehasport
                bis zur Spiraldynamik® greift bei uns alles ineinander. Vier
                Bereiche geben Ihnen einen ersten Überblick.
              </p>
            </FadeUp>
          </div>
          <FadeUp delay={0.2}>
