      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 max-w-2xl">
          ...
          <FadeUp delay={0.15}>
            <p className="mt-6 leading-relaxed text-mist">
              Sie finden unsere Physiotherapie im Fit-in Gesundheitszentrum am
              Steinlein 6 in Karlstadt. Helle Räume, eine ruhige Atmosphäre und
              die direkte Nähe zum Fitness- und Wellnessbereich schaffen den
              Rahmen, in dem Behandlung wirken kann.
            </p>
          </FadeUp>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 md:gap-8">
          <ImageReveal className="relative aspect-[4/3] overflow-hidden rounded-2xl">
            <Image
              src="/images/praxis-1-neu.png"
              alt="Behandlungsraum unserer Physiotherapie mit Therapieliege"
              fill
