        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-16">
            <div className="relative z-10 lg:order-last">
              ...
              >
                Im Fit-in Gesundheitszentrum finden Sie vier Leistungsbereiche
                unter einem Dach: Physiotherapie, Reha-Training, Rehasport und
                Spiraldynamik®. Welcher Weg für Sie der richtige ist,
                entscheidet Ihr Befund und nie ein Schema.
              </motion.p>
              ...
              >
                ...
                <a href="#physiotherapie" className="btn btn-outline btn-lg group">
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  <Image
                    src="/images/leistungen-hero.png"
                    alt="Mobilisation des Kniegelenks einer Patientin auf der Behandlungsbank"
                    fill
                    priority
              ...
              >
                <p className="font-display text-lg text-ink">4 Leistungsbereiche</p>
                <p className="text-sm text-mist">von der Physiotherapie bis zum Rehasport</p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="bg-forest px-5 py-24 text-cream md:px-8 md:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="mb-14 max-w-2xl">
            ...
            <SplitWords
              as="h2"
              text="Für jeden Körper der passende *Weg.*"
          ...
          <div className="grid gap-5 md:grid-cols-2 md:gap-8">
            <FadeUp className="rounded-2xl border hairline-light bg-pine/40 p-8 md:p-10">
              <h3 className="font-display text-2xl">Für Patientinnen und Patienten</h3>
              <p className="mt-4 leading-relaxed text-cream/75">
                Ob nach einer Operation, bei orthopädischen oder neurologischen
                Beschwerden oder zur Nachsorge einer Verletzung: Wir setzen Ihre
                verordnete Therapie um und begleiten Sie Schritt für Schritt
                zurück in einen beweglichen, schmerzärmeren Alltag.
              </p>
            </FadeUp>
            <FadeUp delay={0.12} className="rounded-2xl border hairline-light bg-pine/40 p-8 md:p-10">
              <h3 className="font-display text-2xl">Für aktive und sportliche Menschen</h3>
              <p className="mt-4 leading-relaxed text-cream/75">
                Bei Reiz- und Überlastungsbeschwerden, nach Sportverletzungen
                oder zur Leistungssteigerung verbinden wir Sportphysiotherapie,
                Reha-Training und Spiraldynamik® – mit dem direkten Übergang in
                den Fitnessbereich des Fit-in.
              </p>
            </FadeUp>
          </div>

          <FadeUp delay={0.2} className="mt-12">
            <a href={contact.telefonHref} className="btn btn-light btn-lg">
